...
앱 목록은 기본적으로 `https://api.workith.com/api/gnb/apps`에서 가져온다.
...
pnpm add git+ssh://git@github.com/yegadev/workith-gnb.git#v0.5.1
...
`GnbShell`의 `appsSource`를 생략하면 기본 공급자가 `https://api.workith.com/api/gnb/apps`를
...
const appsSource = new ApiAppsSource('https://api.workith.com/api/gnb/apps', {
